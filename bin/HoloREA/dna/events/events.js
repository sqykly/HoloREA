...
export /**/ var QuantityValue = /** @class */ (function () {
    ...
    QuantityValue.decomposeUnits = function (units) {
        var decomp = units.split("*"), dict = {};
        for (var _i = 0, decomp_2 = decomp; _i < decomp_2.length; _i++) {
            var unit = decomp_2[_i];
            var _a = /^([^\^]*)(?:\^([^]+))?$/.exec(unit), match = _a[0], unitName = _a[1], expo = _a[2];
            var n = parseFloat(expo || "1");
            if (dict.hasOwnProperty(unitName)) {
                n += dict[unitName];
...
export /**/ var LinkRepo = /** @class */ (function () {
    ...
    LinkRepo.prototype.addPredicate = function (trigger, subj, obj) {
        var triggered = this.predicates.get(trigger);
        for (var _i = 0, triggered_3 = triggered; _i < triggered_3.length; _i++) {
            var _a = triggered_3[_i], query = _a.query, dependent = _a.dependent;
            var queried = query.repo.get(subj, query.tag).hashes();
            for (var _b = 0, queried_3 = queried; _b < queried_3.length; _b++) {
                var q = queried_3[_b];
                dependent.repo.put(q, obj, dependent.tag);
            }
        }
    ...
    LinkRepo.prototype.removePredicate = function (trigger, subj, obj) {
        var triggered = this.predicates.get(trigger);
        for (var _i = 0, triggered_4 = triggered; _i < triggered_4.length; _i++) {
            var _a = triggered_4[_i], query = _a.query, dependent = _a.dependent;
            var queried = query.repo.get(subj, query.tag).hashes();
            for (var _b = 0, queried_4 = queried; _b < queried_4.length; _b++) {
                var q = queried_4[_b];
                dependent.repo.remove(q, obj, dependent.tag);
            }
        }
...
export /**/ var QuantityValue = /** @class */ (function () {
    ...
    QuantityValue.decomposeUnits = function (units) {
        var decomp = units.split("*"), dict = {};
        for (var _i = 0, decomp_3 = decomp; _i < decomp_3.length; _i++) {
            var unit = decomp_3[_i];
            var _a = /^([^\^]*)(?:\^([^]+))?$/.exec(unit), match = _a[0], unitName = _a[1], expo = _a[2];
            var n = parseFloat(expo || "1");
            if (dict.hasOwnProperty(unitName)) {
                n += dict[unitName];
...
export /**/ var LinkSet = /** @class */ (function (_super) {
    ...
    LinkSet.prototype.replace = function (fn) {
        ...
        for (var _i = 0, removals_3 = removals; _i < removals_3.length; _i++) {
            var i = removals_3[_i];
            this.splice(i, 1);
        }
        return this;
...
export /**/ var LinkRepo = /** @class */ (function () {
    ...
    LinkRepo.prototype.addPredicate = function (trigger, subj, obj) {
        var triggered = this.predicates.get(trigger);
        for (var _i = 0, triggered_5 = triggered; _i < triggered_5.length; _i++) {
            var _a = triggered_5[_i], query = _a.query, dependent = _a.dependent;
            var queried = query.repo.get(subj, query.tag).hashes();
            for (var _b = 0, queried_5 = queried; _b < queried_5.length; _b++) {
                var q = queried_5[_b];
                dependent.repo.put(q, obj, dependent.tag);
            }
        }
    ...
    LinkRepo.prototype.removePredicate = function (trigger, subj, obj) {
        var triggered = this.predicates.get(trigger);
        for (var _i = 0, triggered_6 = triggered; _i < triggered_6.length; _i++) {
            var _a = triggered_6[_i], query = _a.query, dependent = _a.dependent;
            var queried = query.repo.get(subj, query.tag).hashes();
            for (var _b = 0, queried_6 = queried; _b < queried_6.length; _b++) {
                var q = queried_6[_b];
                dependent.repo.remove(q, obj, dependent.tag);
            }
        }
