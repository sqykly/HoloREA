 ...
 */
declare type Catalog<K extends string, T> = {
    [key: string]: T;
};
/**
 ...
 * @interface
 */
interface CrudResponse<T extends object> {
...
declare class QuantityValue implements QVlike {
    ...
    static decomposeUnits(units: string): {
        [key: string]: number;
    };
    static mulUnits(...decomps: {
        [key: string]: number;
    }[]): {
        [key: string]: number;
    };
    static invertUnits(decomp: {
        [key: string]: number;
    }): {
        [key: string]: number;
    };
    static recomposeUnits(decomp: {
        [key: string]: number;
    }): string;
    isCount(): boolean;
}
 ...
 *
 */
declare class LinkSet<B, L, Tags extends string = string, T extends L = L> extends Array<holochain.GetLinksResponse> {
    private origin;
    private baseHash;
    private onlyTag?;
    constructor(array: Array<holochain.GetLinksResponse>, origin: LinkRepo<B, L, Tags>, baseHash: string, onlyTag?: string);
    /**
...
declare class HoloObject<tE extends Object = {}> implements Named {
     ...
     */
    readonly entry: typeof HoloObject.entryType & tE;
    /**
